...
export const Users = ({ items, isLoading, searchValue, onChangeSearchValue, invites, onClickInvite, onClickSendInvaites }) => {
  return (
    <>
        ...
        <ul className="users-list">
          {
            items.filter((obj) => {
              ...
              <User isInvited={invites.includes(obj.id)} {...obj}
